...
public final class TomlCodec implements Codec, CommentAware {
    ...
    /** The emit order for this table's keys: captured order, then appended keys, re-partitioned by pin zone —
     *  centralized in {@link KeyOrder#arrange}. The scalar-before-table split in {@link #emitTable} then
